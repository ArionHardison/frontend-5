                                    ...
                                    <div class="header-right d-flex justify-content-end">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="menu-close-toggle">
                                                <button @click="toggleMenuModal" type="button" class="btn btn-lg btn-before-dot btn-link border-0 p-0 min-w-auto" data-dismiss="modal" aria-label="Close">Close menu</button>
                                            </div>
                                        </div>
                            ...
                            <div class="modal-body modal-body-centered">
                                <div class="animated fadeinright w-100">
                                    ...
                                    <div class="modal-text">
                                        <p>© {{ new Date().getFullYear() }} Beauty Salon Vue JS Template by Adveits</p>
                                    </div>
                                </div>
                            </div>
