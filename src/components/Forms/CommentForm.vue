<template>
    <form v-on:submit.prevent="submitForm"  action="form.php" method="post" id="commentform" class="comment-form">
        ...
        <div class="form-group form-group-lg">
            ...
            <input v-model="form.author" id="comment-author" name="author" type="text" placeholder="Your name here *" required="required">
        </div>

        <div class="form-group form-group-lg">
            <label class="form-label-lg before after mb-0" for="comment-email">Email</label>
            <input v-model="form.email" id="email" name="comment-email" type="email" placeholder="Your email here *" required="required">
        </div>

        <div class="form-group form-group-lg">
            <label class="form-label-lg before after mb-0" for="comment-url">Website</label>
            <input v-model="form.url" id="comment-url" name="url" placeholder="Your website here" type="url">
        </div>
