<template>
    <form v-on:submit.prevent="submitForm" action="form.php" method="post" id="commentform" class="comment-form">
        <div class="form-group form-group-lg no-lg-space">
            <p class="comment-notes">Your email address will not be published. Required fields are marked <span class="required">*</span></p>
        </div>

        <div class="form-group form-group-xs no-xs-space">
            <textarea v-model="form.comment" id="comment" class="font-size-lg" name="comment" placeholder="Comment *" required="required"></textarea>
        </div>

        <div class="form-group form-group-xs no-xs-space">
            <input v-model="form.author" id="comment-author" class="font-size-lg" name="comment-author" type="text" placeholder="Name *" required="required">
        </div>

        <div class="form-group form-group-xs no-xs-space">
            <input v-model="form.email" id="comment-email" class="font-size-lg" name="comment-email" type="email" placeholder="Email *" required="required">
        </div>

        <div class="form-group form-group-xs">
            <input v-model="form.url" id="comment-url" class="font-size-lg" name="comment-url" placeholder="Website" type="url">
        </div>
        ...
        <div class="form-submit">
            <button name="submit" type="submit" class="btn btn-gradient">Post Comment</button>
        </div>
